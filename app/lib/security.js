...
exports.privilege = function(config, message, listener, my_user = ''){
    ...
    Log.debug('lib user privilege_user ' + my_user + ' ' + is_ok);
    return is_ok;
};
...
exports.access_list = function(config, message, listener){
	...
	Log.debug('lib user access_list ' + my_ACLs + ' ' + acl_is_ok);
    return acl_is_ok;
};
...
exports.validation = function(config, message, listener){
	...
	Log.debug('lib user validation ' + my_user + ' ' + is_validate);
	return is_validate;
};
