...
exports.button = function(controller, bot, message, config, mod_conf) {
    ...
    let body = mod_conf.button.pattern + ' demo(only for Jabber Windows)';
...
exports.open_link = function(controller, bot, message, config, mod_conf) {
    ...
    let body = mod_conf.open_link.pattern + ' demo(only for Jabber Windows)';
    reply_message.text = body;
...
exports.execute_command = function(controller, bot, message, config, mod_conf) {
    ...
    let body = mod_conf.execute_command.pattern + ' demo(only for Jabber Windows)';
    reply_message.text = body;
...
exports.submit = function(controller, bot, message, config, mod_conf) {
    ...
    let body = mod_conf.submit.pattern + ' demo(only for Jabber Windows)';
    reply_message.text = body;
