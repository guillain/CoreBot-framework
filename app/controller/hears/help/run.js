...
module.exports = function(controller, config) {
    ...
    controller.hears(['help', 'help *'], ['message_received', 'direct_message', 'direct_mention', 'group_message'], function (bot, message) {
        ...
        // If all help are requested
            ...
            if (to_say) to_say = config.controller.hears.help.msg.modulefound + '\n' + to_say;
            else        to_say = config.controller.hears.help.msg.modulenotfound;
        ...
        // Help of a module is requested (it includes detail)
            ...
            if (found !== '')
                ...
                to_say = config.controller.hears.help.msg.modulenotfound;
        }
    
        if (to_say === '') to_say = config.controller.hears.help.msg.help;
